...
(function (factory) {
    ...
    $.fn.rating.defaults = {
        ...
        language: 'en',
        stars: 5,
        filledStar: '<i class="fa fa-star" style="color:#2f2f2f"></i>',
        emptyStar: '<i class="fa fa-star" style="color: #aaa;"></i>',
        containerClass: '',
        size: 'md',
        animate: true,
        displayOnly: false,
        ...
        starCaptionClasses: {
            ...
            3: 'label label-secondary badge-secondary',
            3.5: 'label label-success badge-success',
            4: 'label label-success badge-success',
